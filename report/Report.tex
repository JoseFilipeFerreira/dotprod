...
report, we can conclude that memory access optimizations can greaty 
impact an algoritm performance, reducing cache misses, therefore, reducing the
data wait time of the processor.
We can also conclude that GPU proccessing can be a lot faster to process
matrices than a CPU, due to its architecture.
