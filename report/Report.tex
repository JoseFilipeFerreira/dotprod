...
diferent sizes. The smaller one fits in L1 cache, then L2 cache, then L3 cache
...
filled with ones. This way, AxB results in a matrix where all colums have the
same value and BxA results in a matrix where all lines have the same value. This
property was used to assert if all the variations of the algoritm were producing
...
j-k-i trans & 69    & 1375    & 2273077   & 45375529  \\ \hline
\end{tabular}
...
j-k-i trans & .034159 & .008555 & .000902   & .053824   \\ \hline
\end{tabular}
...
\multirow{3}{*}{j-k-i trans} & L1 & .6037 & 7.9182  & 8.4272    & 8.5532    \\ \cline{2-6}
                             & L2 & .3874 & .1204   & .2507     & 6.4841    \\ \cline{2-6}
                             & L3 & .3270 & .0831   & .0087     & 2.9880    \\ \hline
\end{tabular}
